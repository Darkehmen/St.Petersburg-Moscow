...
freq = np.array([50, 28, 50, 28, 30, 50])
...
# Комфорт (1..10)
alpha = np.array([8, 10, 4, 6, 8, 9])
# Надёжность (0..1)
beta = np.array([0.9, 0.9, 0.9, 0.9, 0.95,0.95])

# Переменные издержки на пассажира (руб.)
a = np.array([550, 1400, 100, 400, 400, 500])
# Переменные издержки на рейс (руб.)
b = np.array([490000, 650000, 490000, 650000, 950000, 1190000])
# Постоянные издержки за день (руб.)
c_month = np.array([85000, 185000, 85000, 185000, 1430000, 2800000])
c = c_month / 30
...
# ============================================================
days = np.arange(365)
M_mean = 50000          # среднее число пассажиров в день
