...
# Комфорт (1..10)
alpha = np.array([6, 9, 3, 5, 10])
# Надёжность (0..1)
beta = np.array([0.9, 0.9, 0.9, 0.9, 0.95])

# Переменные издержки на пассажира (руб.)
a = np.array([1200, 1800, 800, 1300, 2000])
# Переменные издержки на рейс (руб.)
b = np.array([30000, 40000, 25000, 35000, 60000])
# Постоянные издержки за день (руб.)
c_month = np.array([500000, 800000, 400000, 700000, 1200000])
c = c_month / 30
...
lambda3 = -0.8
lambda4 = 0.6
lam = 0.0065    # ценовая чувствительность
